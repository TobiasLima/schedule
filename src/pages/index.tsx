...
import { FaWhatsapp, FaFacebookSquare, FaTwitter, FaInstagram, FaBusinessTime } from 'react-icons/fa';
...
const Home: NextPage = () => {
  ...
  const [currentScheduleData, setCurrentScheduleData] = useState<any>({});
